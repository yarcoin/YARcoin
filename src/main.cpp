...
// Copyright (c) 2013 YARcoin developers
...
const string strMessageMagic = "YARcoin Signed Message:\n";
...
static const int64 nStartSubsidy = 100000 * COIN;
static const int64 nMinSubsidy = 100000 * COIN;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("YARcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("YARcoinMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running YARcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("YARcoinMiner terminated\n");
        throw;
    }
}
